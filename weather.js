$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p>Current wheather: " + data.currently.summary + " </p>" +
 
    "<p>Tomorrow: " + data.daily.data[0].summary +  " </p>"+
 
    "<p>In 2 days: " + data.daily.data[1].summary +" Temperature Range: " +" </p>"+
   "<p>In 3 days: " + data.daily.data[2].summary + " </p>"
